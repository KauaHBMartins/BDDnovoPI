...
CREATE TABLE IF NOT EXISTS `mydb`.`Avaliacoes` (
  ...
  INDEX `fk_Avaliacoes_Hospedes1_idx` (`FK_ID_Hospede` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Espacos` (
  ...
  PRIMARY KEY (`ID_Espaco`, `FK_ID_Quarto`, `FK_ID_Sala_Reuniao`, `FK_ID_Computador`),
  INDEX `fk_Espacos_Quartos1_idx` (`FK_ID_Quarto` ASC),
  INDEX `fk_Espacos_Sala_Reunioes1_idx` (`FK_ID_Sala_Reuniao` ASC),
  INDEX `fk_Espacos_Computadores1_idx` (`FK_ID_Computador` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Servicos_Consumidos` (
  ...
  INDEX `fk_Servicos_Consumidos_Hospedes1_idx` (`FK_Hospedes_ID` ASC),
  INDEX `fk_Servicos_Consumidos_Servicos1_idx` (`FK_Servicos_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Info_Login` (
  ...
  INDEX `fk_Info_Login_Hospedes1_idx` (`FK_ID_Hospede` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Espacos_Reservados` (
  ...
  PRIMARY KEY (`ID_Espaco`, `ID_Hospede`, `ID_Espacos_Reservados`),
  INDEX `fk_Espacos_has_Hospedes_Hospedes1_idx` (`ID_Hospede` ASC),
  INDEX `fk_Espacos_has_Hospedes_Espacos1_idx` (`ID_Espaco` ASC),
